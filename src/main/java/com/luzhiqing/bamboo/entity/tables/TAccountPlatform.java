...
public class TAccountPlatform extends TableImpl<TAccountPlatformRecord> {

    private static final long serialVersionUID = -1771773655;

    /**
     * The reference instance of <code>bamboo_auth.t_account_platform</code>
     */
    public static final TAccountPlatform T_ACCOUNT_PLATFORM = new TAccountPlatform();
     ...
     */
    public TAccountPlatform(String alias) {
     ...
     * Create an aliased <code>bamboo_auth.t_account_platform</code> table reference
     */
    public TAccountPlatform(Name alias) {
        this(alias, T_ACCOUNT_PLATFORM);
    }

    private TAccountPlatform(Name alias, Table<TAccountPlatformRecord> aliased) {
        this(alias, aliased, null);
    }

    private TAccountPlatform(Name alias, Table<TAccountPlatformRecord> aliased, Field<?>[] parameters) {
     ...
     */
    @Override
    public TAccountPlatform as(String alias) {
        return new TAccountPlatform(DSL.name(alias), this);
    }
     ...
     */
    @Override
    public TAccountPlatform as(Name alias) {
        return new TAccountPlatform(alias, this);
    }
     ...
     */
    @Override
    public TAccountPlatform rename(String name) {
        return new TAccountPlatform(DSL.name(name), null);
    }
     ...
     */
    @Override
    public TAccountPlatform rename(Name name) {
        return new TAccountPlatform(name, null);
    }
}
