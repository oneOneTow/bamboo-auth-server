...
public class TStaff extends TableImpl<TStaffRecord> {

    private static final long serialVersionUID = 1779542194;

    /**
     * The reference instance of <code>bamboo_auth.t_staff</code>
     */
    public static final TStaff T_STAFF = new TStaff();
     ...
     * Create an aliased <code>bamboo_auth.t_staff</code> table reference
     */
    public TStaff(Name alias) {
        this(alias, T_STAFF);
    }

    private TStaff(Name alias, Table<TStaffRecord> aliased) {
        this(alias, aliased, null);
    }

    private TStaff(Name alias, Table<TStaffRecord> aliased, Field<?>[] parameters) {
     ...
     */
    @Override
    public TStaff as(String alias) {
        return new TStaff(DSL.name(alias), this);
    }
     ...
     */
    @Override
    public TStaff as(Name alias) {
        return new TStaff(alias, this);
    }
     ...
     */
    @Override
    public TStaff rename(String name) {
        return new TStaff(DSL.name(name), null);
    }
     ...
     */
    @Override
    public TStaff rename(Name name) {
        return new TStaff(name, null);
    }
}
