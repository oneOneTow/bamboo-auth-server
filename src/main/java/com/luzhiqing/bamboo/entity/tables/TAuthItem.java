...
public class TAuthItem extends TableImpl<TAuthItemRecord> {

    private static final long serialVersionUID = 1769169508;

    /**
     * The reference instance of <code>bamboo_auth.t_auth_item</code>
     */
    public static final TAuthItem T_AUTH_ITEM = new TAuthItem();
     ...
     * Create an aliased <code>bamboo_auth.t_auth_item</code> table reference
     */
    public TAuthItem(Name alias) {
        this(alias, T_AUTH_ITEM);
    }

    private TAuthItem(Name alias, Table<TAuthItemRecord> aliased) {
        this(alias, aliased, null);
    }

    private TAuthItem(Name alias, Table<TAuthItemRecord> aliased, Field<?>[] parameters) {
     ...
     */
    @Override
    public TAuthItem as(String alias) {
        return new TAuthItem(DSL.name(alias), this);
    }
     ...
     */
    @Override
    public TAuthItem as(Name alias) {
        return new TAuthItem(alias, this);
    }
     ...
     */
    @Override
    public TAuthItem rename(String name) {
        return new TAuthItem(DSL.name(name), null);
    }
     ...
     */
    @Override
    public TAuthItem rename(Name name) {
        return new TAuthItem(name, null);
    }
}
