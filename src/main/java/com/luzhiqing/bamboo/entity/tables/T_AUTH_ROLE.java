...
public class T_AUTH_ROLE extends TableImpl<TAuthRoleRecord> {

    private static final long serialVersionUID = -1729835670;

    /**
     * The reference instance of <code>bamboo_auth.t_auth_role</code>
     */
    public static final T_AUTH_ROLE T_AUTH_ROLE = new T_AUTH_ROLE();
     ...
     */
    public T_AUTH_ROLE(String alias) {
     ...
     * Create an aliased <code>bamboo_auth.t_auth_role</code> table reference
     */
    public T_AUTH_ROLE(Name alias) {
        this(alias, T_AUTH_ROLE);
    }

    private T_AUTH_ROLE(Name alias, Table<TAuthRoleRecord> aliased) {
        this(alias, aliased, null);
    }

    private T_AUTH_ROLE(Name alias, Table<TAuthRoleRecord> aliased, Field<?>[] parameters) {
     ...
     */
    @Override
    public T_AUTH_ROLE as(String alias) {
        return new T_AUTH_ROLE(DSL.name(alias), this);
    }
     ...
     */
    @Override
    public T_AUTH_ROLE as(Name alias) {
        return new T_AUTH_ROLE(alias, this);
    }
     ...
     */
    @Override
    public T_AUTH_ROLE rename(String name) {
        return new T_AUTH_ROLE(DSL.name(name), null);
    }
     ...
     */
    @Override
    public T_AUTH_ROLE rename(Name name) {
        return new T_AUTH_ROLE(name, null);
    }
}
