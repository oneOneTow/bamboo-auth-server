...
public class TAccountUser extends TableImpl<TAccountUserRecord> {

    private static final long serialVersionUID = 1333357338;

    /**
     * The reference instance of <code>bamboo_auth.t_account_user</code>
     */
    public static final TAccountUser T_ACCOUNT_USER = new TAccountUser();
     ...
     */
    public TAccountUser(String alias) {
     ...
     * Create an aliased <code>bamboo_auth.t_account_user</code> table reference
     */
    public TAccountUser(Name alias) {
        this(alias, T_ACCOUNT_USER);
    }

    private TAccountUser(Name alias, Table<TAccountUserRecord> aliased) {
        this(alias, aliased, null);
    }

    private TAccountUser(Name alias, Table<TAccountUserRecord> aliased, Field<?>[] parameters) {
     ...
     */
    @Override
    public TAccountUser as(String alias) {
        return new TAccountUser(DSL.name(alias), this);
    }
     ...
     */
    @Override
    public TAccountUser as(Name alias) {
        return new TAccountUser(alias, this);
    }
     ...
     */
    @Override
    public TAccountUser rename(String name) {
        return new TAccountUser(DSL.name(name), null);
    }
     ...
     */
    @Override
    public TAccountUser rename(Name name) {
        return new TAccountUser(name, null);
    }
}
