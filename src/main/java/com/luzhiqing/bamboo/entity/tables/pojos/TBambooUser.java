...
public class TBambooUser implements Serializable {

    private static final long serialVersionUID = 769883632;
    ...
    public TBambooUser(TBambooUser value) {
        this.id = value.id;
        this.uid = value.uid;
    ...
    public void setUserRole(UByte userRole) {
        this.userRole = userRole;
    }
    ...
    public String toString() {
        StringBuilder sb = new StringBuilder("TBambooUser (");
